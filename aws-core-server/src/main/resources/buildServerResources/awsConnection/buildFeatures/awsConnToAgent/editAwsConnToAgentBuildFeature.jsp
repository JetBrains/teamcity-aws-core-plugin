...
<tr>
  <td colspan="2">
    <em>Select the AWS connection, which will be provided to a build agent. <a target="_blank" rel="noreferrer" href="https://www.jetbrains.com/help/teamcity/aws-credentials.html"><bs:helpIcon/></a></em>
  </td>
</tr>
