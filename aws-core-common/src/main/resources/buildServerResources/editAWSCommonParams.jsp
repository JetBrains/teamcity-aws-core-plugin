...
<c:set var="showDefaultCredentialsChain" value="${not intprop:getBoolean(default_cred_chain_disabled) and not intprop:getBooleanOrTrue(default_cred_chain_hidden) and intprop:getBoolean(default_cred_chain_enabled)}"/>
<c:choose>
